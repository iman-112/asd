  ...
  return (
        ...
        <div className="flex items-center h-screen gap-20 py-20 flex-wrap ">
          <div className="relative md:flex-1 w-[80%] h-[80%] mx-20">
            <Image src="/images/photo.png" alt="" layout="fill" objectFit="contain" />
          </div>
          <div className="md:flex-1 md:text-start text-center">
            <Title addClass="text-6xl">Məhsul adı</Title>
            <span className="text-boz text-2xl font-bold underline underline-offset-1 my-4 inline-block">
              20 AZN
            </span>
            ...
            <div className="flex gap-x-4 my-6 md:justify-start justify-center">
              <label className="flex items-center gap-x-1">
                <input type="checkbox" className="w-5 h-5 accent-sari" />
                <span className="text-sm font-semibold">Qeyd</span>
              </label>
              <label className="flex items-center gap-x-1">
                <input type="checkbox" className="w-5 h-5 accent-sari" />
                <span className="text-sm font-semibold">Qeyd</span>
